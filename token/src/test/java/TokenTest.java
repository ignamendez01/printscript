...
public class TokenTest {
    ...
    public void test_Keyword_let() {
        ...
        Token result = tokenCreator.createToken("let",1,1, "token_types_1.0.txt");
    ...
    public void test_Keyword_const() {
        ...
        Token result = tokenCreator.createToken("const",1,1, "token_types_1.1.txt");
    ...
    public void test_Variable() {
        ...
        Token result = tokenCreator.createToken("x",1,1, "token_types_1.0.txt");
    ...
    public void test_Declaration() {
        ...
        Token result = tokenCreator.createToken(":",1,1, "token_types_1.0.txt");
    ...
    public void test_String_type() {
        ...
        Token result = tokenCreator.createToken("string",1,1, "token_types_1.0.txt");
    ...
    public void test_Number_type() {
        ...
        Token result = tokenCreator.createToken("number",1,1, "token_types_1.0.txt");
    ...
    public void test_Boolean_type() {
        ...
        Token result = tokenCreator.createToken("boolean",1,1, "token_types_1.1.txt");
    ...
    public void test_String() {
        ...
        Token result = tokenCreator.createToken("\"Hello\"",1,1, "token_types_1.0.txt");
    ...
    public void test_Number() {
        ...
        Token result = tokenCreator.createToken("-4.4",1,1, "token_types_1.0.txt");
    ...
    public void test_Boolean_true() {
        ...
        Token result = tokenCreator.createToken("true",1,1, "token_types_1.1.txt");
    ...
    public void test_Boolean_false() {
        ...
        Token result = tokenCreator.createToken("false",1,1, "token_types_1.1.txt");
    ...
    public void test_Method() {
        ...
        Token result = tokenCreator.createToken("println",1,1, "token_types_1.0.txt");
    ...
    public void test_Unknown() {
        ...
        Token result = tokenCreator.createToken("$",1,1, "token_types_1.1.txt");
    ...
    public void test_if() {
        ...
        Token result = tokenCreator.createToken("if",1,1, "token_types_1.1.txt");
    ...
    public void test_else() {
        ...
        Token result = tokenCreator.createToken("else",1,1, "token_types_1.1.txt");
    ...
    public void test_Function_readEnv() {
        ...
        Token result = tokenCreator.createToken("readEnv",1,1, "token_types_1.1.txt");
    ...
    public void test_Function_readInput() {
        ...
        Token result = tokenCreator.createToken("readInput",1,1, "token_types_1.1.txt");
